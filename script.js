...
function irWhatsApp(e) {
    e.preventDefault();
    const num = (typeof siteConfig !== 'undefined' && siteConfig.whatsapp) ? siteConfig.whatsapp : "5511930731230";
...
function updateSlider() {
    ...
    if (container) {
        // Garantimos que o cálculo seja baseado em 100% da largura de um slide
